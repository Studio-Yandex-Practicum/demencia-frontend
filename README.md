...
- Адрес http://dev-demencia.tk

### Админка

- Адрес: http://dev-demencia.tk:8080/admin
- Логин: admin_demencia
- Пароль: Op#z29cOP

### Полигон для просмотра и теста API

- Адрес: http://dev-demencia.tk:8080/graphql
...
19. Любое значение
    20, 21. Изображение в поле image
20. Слова разделенные запятыми
21. Выбранные значения в формате 1А2Б3В4Г5Д6Е
22. Значения оставшихся спичек в формате 3,4,5,6,7,8. Все спички условно пронумерованы с 1 по 8, слева направо, сверху вниз
23. Введенный ответ (отредактировано)
